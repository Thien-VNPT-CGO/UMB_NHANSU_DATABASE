...
export class MockSheetsAdapter implements ISheetsRepository {
  ...
  public seedInitialData() {
    ...
    // 4b. Candidates tuyển dụng ban đầu (17 cột chuẩn Google Forms)
    this.candidates = [
      {
        submission_id: 'CAND_0001',
        full_name: 'Nguyễn Minh Khang',
        gender: 'Nam',
        birth_year: 2002,
        education_level: 'Đại học Sài Gòn',
        hometown: 'Long An',
        phone: '0918234567',
        phone_normalized: '0918234567',
        registered_shift: 'Ca sáng (06:30 - 14:30)',
        preferred_branch_id: 'CN130',
        branch_name: 'CN130 - Lê Văn Sỹ',
        experience: '1 năm pha chế The Coffee House, thành thạo máy pha cafe & pha trà sữa',
        ...
        created_at: '2026-09-24T08:30:15.000Z',
      },
      {
        submission_id: 'CAND_0002',
        full_name: 'Trần Ngọc Thảo',
        gender: 'Nữ',
        birth_year: 2003,
        education_level: 'Cao đẳng Kinh tế',
        hometown: 'Tiền Giang',
        phone: '0987123456',
        phone_normalized: '0987123456',
        registered_shift: 'Ca chiều (14:30 - 22:30)',
        preferred_branch_id: 'CN132',
        branch_name: 'CN132 - Hàng Tre',
        experience: '6 tháng thu ngân Phúc Long, cẩn thận kiểm soát tiền mặt & POS',
      ...
      {
        submission_id: 'CAND_0003',
        full_name: 'Lê Hoàng Quân',
        gender: 'Nam',
        birth_year: 2001,
        education_level: 'Đại học HUTECH',
        hometown: 'Bình Dương',
        phone: '0938456789',
        phone_normalized: '0938456789',
        registered_shift: 'Xoay ca linh hoạt',
        preferred_branch_id: 'CN134',
        branch_name: 'CN134 - Sư Vạn Hạnh',
        experience: '2 năm quản lý ca & pha chế tại chuỗi trà sữa, giao tiếp tiếng Anh tốt',
        ...
        created_at: '2026-09-24T10:05:22.000Z',
      },
      {
        submission_id: 'CAND_0004',
        full_name: 'Phạm Quỳnh Như',
        gender: 'Nữ',
        birth_year: 2004,
        education_level: 'Đại học Mở TP.HCM',
        hometown: 'Đồng Nai',
        phone: '0909567890',
        phone_normalized: '0909567890',
        registered_shift: 'Ca tối (18:00 - 23:00)',
        preferred_branch_id: 'CN130',
        branch_name: 'CN130 - Lê Văn Sỹ',
        experience: 'Sinh viên năm 2 năng động, nhanh nhẹn, chưa có kinh nghiệm F&B',
      ...
      {
        submission_id: 'CAND_0005',
        full_name: 'Đặng Tuấn Kiệt',
        gender: 'Nam',
        birth_year: 2000,
        education_level: 'Đại học Công Nghiệp TP.HCM',
        hometown: 'An Giang',
        phone: '0977889900',
        phone_normalized: '0977889900',
        registered_shift: 'Full-time (Tất cả các ca)',
        preferred_branch_id: 'CN132',
        branch_name: 'CN132 - Hàng Tre',
        experience: '1.5 năm Barista chuyên nghiệp, thành thạo Latte Art và pha chế sữa tươi trân châu',
        ...
        created_at: '2026-09-24T12:45:10.000Z',
      },
      {
        submission_id: 'CAND_0006',
        full_name: 'Vũ Thị Thùy Dung',
        gender: 'Nữ',
        birth_year: 2003,
        education_level: 'Cao đẳng FPT Polytechnic',
        hometown: 'Bến Tre',
        phone: '0945678123',
        phone_normalized: '0945678123',
        registered_shift: 'Ca sáng (06:30 - 14:30)',
        preferred_branch_id: 'CN134',
        branch_name: 'CN134 - Sư Vạn Hạnh',
        experience: '1 năm phục vụ chuỗi bánh mì kem & trà sữa, giọng nói nhẹ nhàng',
        ...
        created_at: '2026-09-24T13:10:30.000Z',
      },
    ];
  ...
  async setAccountPin(id: string, pinHash: string, mustChange: boolean, actorId: string): Promise<EmployeeAccount> {
    ...
    await this.recordAuditLog({
      ...
      actor_id: actorId,
      actor_role: 'HR',
      action: mustChange ? 'ACCOUNT_PIN_ISSUED' : 'ACCOUNT_PIN_CHANGED',
