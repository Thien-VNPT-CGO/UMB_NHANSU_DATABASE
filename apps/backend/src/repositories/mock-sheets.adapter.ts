...
export class MockSheetsAdapter implements ISheetsRepository {
  ...
  public seedInitialData() {
    ...
    this.adminAccounts = [
      ...
      {
        admin_id: 'STORE_CN130',
        username: 'store_130',
        password_hash: 'store123',
        full_name: 'Cửa Hàng Trưởng CN 130',
        role: 'STORE',
        branch_scope: 'CN130',
        is_active: true,
        version: 1,
      ...
      {
        admin_id: 'STORE_CN261',
        username: 'store_261',
        password_hash: 'store123',
        full_name: 'Cửa Hàng Trưởng CN 261',
        role: 'STORE',
        branch_scope: 'CN261',
        is_active: true,
        version: 1,
      ...
      },
      {
        ...
        full_name: 'Kế Toán Trưởng Ụm Bò Milk',
        role: 'FINANCE',
        branch_scope: '*',
        is_active: true,
        version: 1,
      ...
      },
      {
        ...
        full_name: 'Trưởng Nhóm Truyền Thông MKT',
        role: 'MARKETING',
        branch_scope: '*',
        is_active: true,
        version: 1,
    ...
    // 2. Employees (Probation, Official, Pending Activation, Suspended, Duplicate Phone)
    this.employees = [
      {
        employee_id: 'EMP_001',
        employee_code: 'UBM_NV0001',
        full_name: 'Nguyễn Văn An',
        phone_normalized: '0901111222',
        gender: 'NAM',
        birth_date: '2002-05-15',
        employment_status: 'PROBATION',
        group: 'STORE',
        default_branch_id: 'CN130',
        current_rate_per_hour: STANDARD_HOURLY_RATES.PROBATION,
      ...
      {
        employee_id: 'EMP_002',
        employee_code: 'UBM_NV0002',
        full_name: 'Trần Thị Bình',
        phone_normalized: '0903333444',
        gender: 'NU',
      ...
      {
        employee_id: 'EMP_004',
        employee_code: 'UBM_NV0004',
        full_name: 'Phạm Đức Dũng',
        phone_normalized: '0907777888',
        gender: 'NAM',
      ...
      // For duplicate phone test (AUTH-05)
      {
        employee_id: 'EMP_DUP_1',
        employee_code: 'UBM_NV0088',
        full_name: 'Vũ Trọng Hùng (Trùng SĐT)',
        phone_normalized: '0909999000',
        employment_status: 'PROBATION',
        group: 'STORE',
        default_branch_id: 'CN130',
        current_rate_per_hour: STANDARD_HOURLY_RATES.PROBATION,
      ...
      },
      {
        ...
        employee_code: 'UBM_NV0089',
        full_name: 'Vũ Trọng Hùng (Bản Ghi 2)',
        phone_normalized: '0909999000',
        employment_status: 'PROBATION',
        group: 'STORE',
        default_branch_id: 'CN130',
      ...
      {
        employee_id: 'EMP_005',
        employee_code: 'UBM_NV0005',
        full_name: 'Lê Minh Đạt',
        phone_normalized: '0908888999',
        employment_status: 'PRE_ONBOARDING',
        group: 'STORE',
        default_branch_id: 'CN120',
        current_rate_per_hour: STANDARD_HOURLY_RATES.PROBATION,
      ...
      {
        employee_id: 'EMP_006',
        employee_code: 'UBM_NV0006',
        full_name: 'Vũ Văn Giang (Xưởng SX)',
        phone_normalized: '0902222333',
        employment_status: 'OFFICIAL',
        group: 'XUONG',
        default_branch_id: 'XUONG_SX',
        current_rate_per_hour: STANDARD_HOURLY_RATES.OFFICIAL,
      ...
      {
        employee_id: 'EMP_007',
        employee_code: 'UBM_NV0007',
        full_name: 'Đặng Hoàng Hà (Văn Phòng)',
        phone_normalized: '0904444555',
        employment_status: 'OFFICIAL',
        group: 'VAN_PHONG',
        default_branch_id: 'VAN_PHONG',
        current_rate_per_hour: STANDARD_HOURLY_RATES.OFFICIAL,
      ...
      {
        employee_id: 'EMP_008',
        employee_code: 'UBM_NV0008',
        full_name: 'Bùi Quỳnh Chi (Sale MKT)',
        phone_normalized: '0906666777',
        employment_status: 'PROBATION',
        group: 'SALE',
        default_branch_id: 'CN111',
        current_rate_per_hour: STANDARD_HOURLY_RATES.PROBATION,
    ...
    // 4. Sample Shifts for Current Date
    const today = new Date().toISOString().split('T')[0];
    this.shifts = [
      {
        assignment_id: 'SHIFT_001',
        employee_id: 'EMP_001', // An
        branch_id: 'CN130',
        shift_code: 'CA_1',
        date: today,
        start_at: `${today}T07:00:00+07:00`,
        end_at: `${today}T12:00:00+07:00`,
        status: 'PUBLISHED',
        schedule_version: 1,
        created_at: now,
        updated_at: now,
      ...
      {
        assignment_id: 'SHIFT_002',
        employee_id: 'EMP_002', // Bình
        branch_id: 'CN130',
        shift_code: 'CA_2',
        date: today,
        start_at: `${today}T12:00:00+07:00`,
        end_at: `${today}T18:00:00+07:00`,
        status: 'PUBLISHED',
        schedule_version: 1,
        created_at: now,
        updated_at: now,
    ...
    this.notificationInbox = [
      {
        inbox_id: 'NOTIF_001',
        notification_id: 'OUT_001',
        recipient_id: 'EMP_001',
        title: 'Chào mừng gia nhập Ụm Bò Milk',
        summary: 'Tài khoản của bạn đã được kích hoạt. Hãy xem lịch làm việc tuần này.',
        severity: 'SUCCESS',
        target_path: '/schedule',
        created_at: now,
        version: 1,
      },
      {
        inbox_id: 'NOTIF_002',
        notification_id: 'OUT_002',
        recipient_id: 'ALL',
        title: 'Cảnh báo định biên: CN111 thiếu nhân sự ca 3',
        summary: 'Chi nhánh 111 chưa đủ định biên tối thiểu (2 NV) cho ca tối 18:00 - 23:00.',
        severity: 'URGENT',
        target_path: '/schedules',
        created_at: now,
        version: 1,
      },
    ];
