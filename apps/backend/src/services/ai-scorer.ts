...
export interface AiScoringResult {
  ...
  breakdown: {
    c1_name: { points: number; max: 1; note: string };
    c2_birth_year: { points: number; max: 2; note: string };
    c3_hometown: { points: number; max: 1; note: string };
    c4_phone: { points: number; max: 1; note: string };
    c5_education: { points: number; max: 2; note: string };
    c6_experience: { points: number; max: 2; note: string };
    c7_referral: { points: number; max: 1; note: string; disqualified?: boolean };
    c8_emergency: { points: number; max: 2; note: string; disqualified?: boolean };
    c9_facebook: { points: number; max: 2; note: string; disqualified?: boolean };
  };
}
...
export function evaluateCandidateAiScore(candidate: {
  ...
  return {
    ...
    screeningNote,
    breakdown: {
      c1_name: { points: c1Points, max: 1, note: c1Note },
      c2_birth_year: { points: c2Points, max: 2, note: c2Note },
      c3_hometown: { points: c3Points, max: 1, note: c3Note },
      c4_phone: { points: c4Points, max: 1, note: c4Note },
      c5_education: { points: c5Points, max: 2, note: c5Note },
      c6_experience: { points: c6Points, max: 2, note: c6Note },
      c7_referral: { points: c7Points, max: 1, note: c7Note, disqualified: c7Disqualified },
      c8_emergency: { points: c8Points, max: 2, note: c8Note, disqualified: c8Disqualified },
      c9_facebook: { points: c9Points, max: 2, note: c9Note, disqualified: c9Disqualified },
    },
  };
}
