...
// Dùng looseOptString: form admin có thể gửi null/number (autofill) — vẫn
// chấp nhận thay vì trả VALIDATION_ERROR chung chung.
export const employeeCreateBody = z
  .object({
    fullName: looseOptString(100),
    full_name: looseOptString(100),
    phone: looseOptString(20),
    phone_normalized: looseOptString(20),
    branchId: looseOptString(32),
    branch_id: looseOptString(32),
    default_branch_id: looseOptString(32),
    employmentStatus: looseOptString(32),
    employment_status: looseOptString(32),
    gender: looseOptString(10),
    group: looseOptString(32),
    employeeCode: looseOptString(32),
    employee_code: looseOptString(32),
    idCardNumber: looseOptString(32),
    id_card_number: looseOptString(32),
    email: looseOptString(100),
    birthDate: looseOptString(64),
    birth_date: looseOptString(64),
    startDate: looseOptString(64),
    start_date: looseOptString(64),
    officialDate: looseOptString(64),
    official_date: looseOptString(64),
